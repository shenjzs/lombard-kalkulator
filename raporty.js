...
async function loadRealData() {
    ...
    try {
        ...
        // ==========================================
        // RENDEROWANIE LIVE FEED (MODYFIKACJA: PRAWDZIWE ID I SORTOWANIE)
        // ==========================================
        const renderLiveFeed = () => {
            ...
            // 1. Grupowanie w paragony
            rawFeed.forEach((item, index) => {
                // Jeśli serwer zwrócił prawdziwe ID raportu, używamy go do grupowania. 
                // Jeśli jest to stary paragon (bez ID), tworzymy unikalny klucz łącząc pracownika, datę i typ.
                ...
                if (!groupedTransactions[key]) {
                    groupedTransactions[key] = {
                        ...
                        totalAmount: 0,
                        items: [],
                        sortIndex: index // <--- Zapisujemy oryginalną kolejność wierszy, żeby zlikwidować skakanie
                    };
                }
            ...
            // 2. Sortowanie (Najpierw chronologicznie po dacie, a jeśli daty są równe - po oryginalnej kolejności)
            const sortedTransactions = Object.values(groupedTransactions).sort((a, b) => {
                ...
                return b.sortIndex - a.sortIndex; // Jeśli to samo, to wpis znajdujący się niżej w arkuszu idzie na górę
            });
        ...
        // RENDEROWANIE WYKRESÓW (PRZEKAZANIE HOURLY DATA)
...
// ==========================================
// FUNKCJA RYSUJĄCA WYKRESY (CHART.JS) + NOWY WYKRES GODZIN
// ==========================================
