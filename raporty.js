    ...
    try {
        ...
        const renderLiveFeed = () => {
            ...
            container.innerHTML = feedItems.map(item => {
                ...
                // Jeśli data przychodzi w starym formacie ISO, to konwertujemy na datę + godzinę!
                if (typeof displayDate === 'string' && displayDate.includes('T')) {
                    const d = new Date(displayDate);
                    displayDate = d.toLocaleString('pl-PL'); 
                }
                // (jeśli kasa wyśle datę z godziną ręcznie jako string np. "08.05.2026 15:30:00", to wyświetli się wprost)
